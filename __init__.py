...
from .Datasets import nodes as dataset_nodes
...
NODE_CLASS_MAPPINGS = {
    ...
    "DOES_custom_nodes_LoadDataSet": dataset_nodes.LoadDataSet,
    "DOES_custom_nodes_LoadDataSetFromURL": dataset_nodes.LoadDataSetFromURL,
    "DOES_custom_nodes_LoadNextImage": dataset_nodes.LoadNextImage,
}
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "DOES_custom_nodes_LoadDataSet": "🐑 Load dataset",
    "DOES_custom_nodes_LoadDataSetFromURL": "🐑 Load dataset from URL",
    "DOES_custom_nodes_LoadNextImage": "🐑 Load image from dataset",
}